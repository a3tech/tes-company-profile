...
"[project]/new_journey_2025/CompanyProfile/fe_next_js/app/admin/project/new/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewProject() {
    ...
    async function submit(e) {
        e.preventDefault();
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$new_journey_2025$2f$CompanyProfile$2f$fe_next_js$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])('/projects', {
                method: 'POST',
                auth: true,
                body: {
                    title,
...
_s(NewProject, "WhQIRUYaBCEaVW3Hw+5/dS7jzzE=", false, function() {
    return [
...
//# sourceMappingURL=new_journey_2025_CompanyProfile_fe_next_js_471e4e9b._.js.map